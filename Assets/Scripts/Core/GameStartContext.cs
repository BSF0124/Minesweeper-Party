...
public class GameStartContext
{
    ...
    // 선택된 난이도
    private static Difficulty _difficulty = Difficulty.None;
    ...
    public static void SetClassic(Difficulty difficulty)
    {
    ...
    public static bool TryGet(out GameMode mode, out Difficulty difficulty)
    {
        mode = _mode;
        difficulty = _difficulty;
        return _mode != GameMode.None;
    }
